...
import { esVideoYoutube, youtubeEmbedUrl } from "@/lib/video";
...
export default async function ProductoDetallePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const embedYoutube = producto.videoMuestraUrl && esVideoYoutube(producto.videoMuestraUrl)
    ? youtubeEmbedUrl(producto.videoMuestraUrl)
    : null;
  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="max-w-4xl mx-auto w-full px-6 sm:px-8 py-12">
        ...
        {producto.videoMuestraUrl && (
          <div className="mt-12">
            <h2 className="font-display font-semibold text-lg mb-4">Video de muestra</h2>
            <div className="aspect-video bg-surface-alt rounded-2xl overflow-hidden">
              {embedYoutube ? (
                ...
                <video src={producto.videoMuestraUrl} controls className="w-full h-full" />
              )}
            </div>
          </div>
        )}
